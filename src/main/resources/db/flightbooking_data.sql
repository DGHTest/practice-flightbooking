...
INSERT INTO `passenger` (last_names, first_name, birth_date, email, telephone_number, country, state, city, passport_number, expiration_date, nationality, active) VALUES
...
INSERT INTO `ticket` (id_passenger, boarding_time) VALUES
(1, {ts '2022-10-09 16:00:00'}),
(1, {ts '2022-11-19 11:30:00'}),
(2, {ts '2022-11-19 11:30:00'});
