INSERT INTO `airport` (airport_name, country, state, city, iata, icao) VALUES
...
INSERT INTO `arrival_flight` (id_airport, arrival_time, arrival_status) VALUES
(3, {ts '2022-10-09 16:30:00'}, 1),
(3, {ts '2022-11-09 16:30:00'}, 1),
(4, {ts '2022-11-09 16:30:00'}, 1);
INSERT INTO `departure` (id_airport, departure_time, departure_status) VALUES
(1, {ts '2022-10-09 20:10:00'}, 1),
(2, {ts '2022-11-09 20:10:00'}, 1),
(5, {ts '2022-11-09 20:10:00'}, 1);
INSERT INTO `passenger` (last_names, first_name, birth_date, email, telephone_number, country, state, city, passport_number, expiration_date, nationality, passenger_status) VALUES
...
INSERT INTO `travel` (id_arrival_flight, id_departure, price, travel_status) VALUES
(1, 1, 10000.00, 1),
(2, 2, 10000.00, 1),
(3, 3, 20000.00, 1);
